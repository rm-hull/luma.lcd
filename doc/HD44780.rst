...
* The size of the progress bar was carefully chosen.  It is 70 pixels wide by 8
  ...
  characters regardless of what position the progress value is set to.
  ...
  .. csv-table:: **CUSTOM CHARACTERS**
    ...
    :widths: 15, 15, 15
      ...
      "LEmpty", "MEmpty", "REmpty"
      "Filling", "MEmpty", "REmpty"
      "Filled", "Filling, MEmpty", "REmpty"
      "Filled", "Filled, Filling, MEmpty", "REmpty"
      "Filled", "Filled", "RFilling"
      "Filled", "Filled", "Filled"

  So the maximum number of custom characters is as little as 1 but never exceeds 4.
