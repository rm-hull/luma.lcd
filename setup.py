...
setup(
    ...
    description=("A library to drive PCD8544, HT1621, ST7735, ST7789, ST7567 and UC1701X-based LCDs"),
    long_description="\n\n".join([README, CONTRIB, CHANGES]),
    license="MIT",
    keywords="raspberry pi rpi lcd nokia 5110 display screen pcd8544 st7735 st7789 uc1701x ht1621 spi 84x48 160x128",
